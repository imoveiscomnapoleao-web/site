...
- Assinatura sugerida: Casal especialista em imoveis premium
- Paleta principal: azul escuro, azul claro e branco
- Apoio funcional: verde apenas para botoes de WhatsApp
- Estilo: sofisticado, moderno, limpo, com visual inspirado em imobiliarias premium de Alphaville
...
2. Imoveis
   - Listagem por regiao
   - Filtros por tipo, valor, quartos, vagas e condominio
   - Pagina individual de cada imovel com fotos, descricao, mapa e WhatsApp
   - Catalogo criado em `catalogo.html`
   - Paginas individuais criadas na pasta `imoveis`

3. Quer vender seu imovel?
   - Pagina para captacao de proprietarios
   - Formulario com nome, telefone, regiao, tipo de imovel e objetivo
   - Argumentos de avaliacao, posicionamento, divulgacao e negociacao
   - Reforco do atendimento em casal aos interessados
...
5. Blog
   - Conteudos para aparecer no Google
   - Guias de compra, venda, bairros, financiamento e valorizacao
...
8. Sobre Napoleao & Akylla Marques
   ...
   - Mais de R$ 300 milhoes em VGV vendido
...
Encontre o imovel certo com um casal especialista que conhece Alphaville, Barueri, Osasco, Sao Paulo e Santana de Parnaiba.

## Ideias de artigos para SEO

- Casas em Alphaville: como escolher o condominio ideal
- Vale a pena comprar imovel em Barueri?
- Como vender um imovel mais rapido em Alphaville
- Osasco: bairros com melhor potencial de valorizacao
- Sao Paulo: guia para quem busca apartamento bem localizado
- Santana de Parnaiba: onde morar com qualidade de vida
- Como preparar seu imovel para fotos e visitas
- Erros comuns ao anunciar um imovel de alto padrao
- Por que comprar imovel com assessoria imobiliaria em casal
- Como a experiencia em gestao de vendas ajuda na negociacao imobiliaria
...
Dominio registrado e conectado:

`imoveiscomnapoleaoviana.com.br`

Enderecos principais:

- `https://imoveiscomnapoleaoviana.com.br`
- `https://www.imoveiscomnapoleaoviana.com.br`

## Proximos passos

1. Revisar os textos finais da home, catalogo e paginas de imoveis.
2. Substituir fotos provisorias por fotos profissionais novas.
3. Inserir novos imoveis reais no catalogo.
4. Criar paginas separadas para vender, regioes, blog, videos e contato.
5. Subir os arquivos atualizados no GitHub.
6. Aguardar a Vercel publicar automaticamente.
7. Configurar Google Analytics, Search Console e pixel de anuncios.

## Dados necessarios para cadastrar um imovel real

- Codigo do imovel
- Titulo comercial
- Cidade, bairro e condominio
- Tipo: casa, apartamento, cobertura ou terreno
- Valor de venda ou "sob consulta"
- Metragem
- Dormitorios, suites e vagas
- Valor de condominio e IPTU, se quiser exibir
- Descricao completa
